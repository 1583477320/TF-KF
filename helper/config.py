...
def get_params():
    ...
    params["cnn_model"]="/home/zhao/pyproject/TF-KF/model/model_final.pth"
    ...
    params['P_mul']= 0.1
    params['K_inp']=51
    params['n_input']= 51#1536#48#2048
    ...
    params['dropout'] = 0.1
    params['Q_d_model'] = 256
    params['Q_nhead'] = 4
    params['Q_num_layers'] = 1
    params['R_d_model'] = 256
    params['R_nhead'] = 4
    params['R_num_layers'] = 1
    ...
    params['train_data_path'] = "/home/zhao/pyproject/TF-KF/data/h36m/annot/train.h5"
    params['test_data_path'] = "/home/zhao/pyproject/TF-KF/data/h36m/annot/valid.h5"
    params['cp_file'] = "/home/zhao/pyproject/TF-KF/model"
    params['h36m_root'] = "/home/zhao/pyproject/TF-KF/data/h36m"
    params['cache_dir'] = "/home/zhao/pyproject/TF-KF/data/h36m/cache"
    ...
    # if (platform.node() == "zhaoteam"):
    #     params["data_bin"] = "/home/zhao/pyproject/TF-KF/data/h36m/full-2048.h5"
    #     params["batch_size"] = 5
